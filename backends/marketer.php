...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $englishLevel          = mysqli_real_escape_string($connection, $_POST["englishLevel"]);
    $description      = mysqli_real_escape_string($connection, $_POST["description"]);
    $salary        = intval($_POST["salary"]);
    $startDate            = mysqli_real_escape_string($connection, $_POST["startDate"]);
    $relocation           = mysqli_real_escape_string($connection, $_POST["relocation"]);
    $additionalInfo = mysqli_real_escape_string($connection, $_POST["additionalInfo"]);
    $offSource = mysqli_real_escape_string($connection, $_POST["offerSource"]);

    // Define upload directories (ensure these folders exist and are writable)
    $uploadDir = "../uploads/";
    ...
    $sql = "INSERT INTO marketing (fullname, email, level, englishLevel, description, salary, startDate, relocation, additionalInfo, offerSource, cvPath) VALUES ('$fullName', '$email', '$level', '$englishLevel', '$description', '$salary', '$startDate', '$relocation', '$additionalInfo', '$offSource', '$cvPath')";
            ...
            <!DOCTYPE html>
                            ...
                            <body>
                                ...
                                <ul class='user-info'>
                                    ...
                                    <li><strong>English Level:</strong> $englishLevel </li>
                                    <li><strong>Description:</strong> $description </li>
                                    <li><strong>Salary Expectation:</strong> $salary </li>
                                    <li><strong>When to start work:</strong> $startDate </li>
                                    <li><strong>On Site or Remote:</strong> $relocation </li>
                                    <li><strong>Additional Info:</strong> $additionalInfo </li>
                                    <li><strong>Where did you find our offer:</strong> $offSource </li>
