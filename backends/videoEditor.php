...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $uploadDir = "../uploads/";
    $cvDir = $uploadDir . "marketing/cv/";
    $coverLetterDir = $uploadDir . "marketing/cover_letters/";
    ...
    // SQL insertion
    $sql = "INSERT INTO videoediting (fullName, email, phone, experience, location, resume, coverLetter)
            VALUES ('$fullName', '$email', '$phone', '$experience', '$location', '$resumeFileName', '$coverLetterFileName')";
    ...
    if (mysqli_query($connection, $sql)) {
        ...
        $subjectAdmin = "New Video Editing Application";
        $messageAdmin = "
            <!DOCTYPE html>
                            <html>
                            <head>
                            ...
                            <body>
                                ...
                                <ul class='user-info'>
                                    ...
                                    <li><strong>CV:</strong> <a href='http://localhost/deaconspublishers/uploads/marketing/cv/$resumeFileName'>Download CV</a></li>
                                    <li><strong>Cover Letter:</strong> <a href='http://localhost/deaconspublishers/uploads/marketing/cover_letters/$coverLetterFileName'>Download Cover Letter</a></li>
