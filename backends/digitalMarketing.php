...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $currentAddress    = mysqli_real_escape_string($connection, $_POST["currentAddress"]);
    $position          = mysqli_real_escape_string($connection, $_POST["position"]);
    $workLocation      = mysqli_real_escape_string($connection, $_POST["workLocation"]);
    ...
    $whyWork           = mysqli_real_escape_string($connection, $_POST["whyWork"]);
    $impactfulCampaign = mysqli_real_escape_string($connection, $_POST["impactfulCampaign"]);
    ...
    // Handle CV upload
    $cvFileName = handleFileUpload("cv", "cv_", $cvDir);
    echo "CV uploaded successfully: " . $cvFileName;
    ...
    // Insert data into the digitalmarketing table
    $sql = "INSERT INTO digitalmarketing (fullName, email, phone, currentAddress, position, workLocation, startDate, education, experience, skills, cv, coverLetter, whyWork, impactfulCampaign)
            VALUES ('$fullName', '$email', '$phone', '$currentAddress', '$position', '$workLocation', '$startDate', '$education', $experience, '$skills', '$cvPath', '$coverLetterPath', '$whyWork', '$impactfulCampaign')";

    if (mysqli_query($connection, $sql)) {
        // Email details for sending
        $adminEmail    = "deaconspublishers@gmail.com";
        $adminPassword = "cjanqzfvgfindzms"; // App-specific password

        // Prepare email content for Admin
        $subjectAdmin = "New Digital Marketing Application";
        $messageAdmin = "
            <!DOCTYPE html>
                            <html>
                            <head>
                            ...
                            <body>
                                ...
                                <ul class='user-info'>
                                    ...
                                    <li><strong>Preferred Work Location:</strong> $workLocation </li>
                                    ...
                                    <li><strong>CV:</strong> <a href='http://localhost/deaconspublishers/uploads/marketing/$cvFileName'>Download CV</a></li>
                                    <li><strong>CV:</strong> <a href='http://localhost/deaconspublishers/uploads/marketing/$coverLetterFileName'>Download Cover Letter</a></li>
                                    <li><strong>Why Work With Us:</strong>  $whyWork </li>
                                    <li><strong>Impactful Campaign:</strong>  $impactfulCampaign </li>
                                </ul>
        ...
        try {
            ...
            echo "Your application has been submitted successfully. Check your email for confirmation.";
        } catch (Exception $e) {
